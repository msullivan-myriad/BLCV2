...
class GoalEstimateService {
  ...
  public function setGoalEstimateExperienceAndSubgoalWeights() {
    ...
    $totalExperienceAndSubgoalCount = $subgoalCount + $experienceCount;

    $this->experienceWeight = $experienceCount/$totalExperienceAndSubgoalCount;
    $this->subgoalWeight = $subgoalCount/$totalExperienceAndSubgoalCount;
